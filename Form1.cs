...
namespace Caso01
{
    public partial class frmLlamdasConValorRetornoConParametro : Form
    {
        public frmLlamdasConValorRetornoConParametro()
        {
            InitializeComponent();
            tHora.Enabled = true;
        }

        private void frmLlamdasConValorRetornoConParametro_Load(object sender, EventArgs e)
        {
        ...
        double asignaCostoxLlamada(string horario)
        {
            ...
            switch (horario)
            {
                ...
                case "Diurno(13:00-19:00)": descuento = importe * 0.2; break;
                case "Diurno(19:00-23:00)": descuento = importe * 0.1; break;
